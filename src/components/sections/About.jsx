...
function About() {
  return (
    <section className='flex flex-col gap-5 items-start' id='about'>
        ...
        <div className='flex flex-col-reverse md:items-center gap-5 md:gap-10 md:flex-row'>
            <img src="https://r11.es/assets/about_1.png" alt="About macbook image" className='rounded-default md:max-w-72' />
        ...
        <div className='flex flex-col md:items-center gap-5 md:gap-10 md:flex-row'>
            ...
            <img src="https://r11.es/assets/about_2.png" alt="About iphone image" className='rounded-default md:max-w-72' />
        </div>
    </section>
  )
}
